# coding: utf-8
# Baseline generated by sqlacodegen mysql://finance_user:finance_pass@localhost/pa_philly_campaign_finance
...
class OpenAddresses(Base):
    __tablename__ = 'open_addresses'

    id = Column(Integer, primary_key=True)

    number = Column(String(16), nullable=False, server_default='')
    street = Column(String(64), nullable=False, server_default='')
